...
<head>
  ...
  <title>🍬YourSweetPlug| Home</title>
  <style>
    body {
      margin: 0;
...
<body>
  ...
  <div class="checkout-box">
    ...
    <p>Please send your payment to the address below:</p>

    <div class="crypto-option">
      <label for="crypto-select">Choose Crypto:</label>
    ...
    <button onclick="confirmPayment()">I’ve Paid</button>
  </div>
  ...
  <script>
    ...
    function confirmPayment() {
      alert("Thank you! Please wait while we confirm your payment manually.");
      // Optional: trigger webhook, send email, etc.
    }
